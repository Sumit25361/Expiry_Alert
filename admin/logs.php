...
switch ($dateFilter) {
    case 'today':
        $whereConditions[] = "DATE(aal.created_at) = CURDATE()";
        break;
    case 'week':
        $whereConditions[] = "aal.created_at >= DATE_SUB(NOW(), INTERVAL 7 DAY)";
        break;
    case 'month':
        $whereConditions[] = "aal.created_at >= DATE_SUB(NOW(), INTERVAL 30 DAY)";
        break;
}
...
// Get total count
$countQuery = "SELECT COUNT(*) as total FROM admin_activity_log aal $whereClause";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                        ...
                        <form method="GET" class="form-inline">
                            <div class="form-group mr-3">
                                ...
                                <select name="log_type" id="log_type" class="form-control">
                                    <option value="all" <?php echo $logType === 'all' ? 'selected' : ''; ?>>All Types
                                    </option>
                                    <option value="login" <?php echo $logType === 'login' ? 'selected' : ''; ?>>Login
                                    </option>
                                    <option value="logout" <?php echo $logType === 'logout' ? 'selected' : ''; ?>>Logout
                                    </option>
                            ...
                            <div class="form-group mr-3">
                                ...
                                <select name="date_filter" id="date_filter" class="form-control">
                                    ...
                                    <option value="week" <?php echo $dateFilter === 'week' ? 'selected' : ''; ?>>This Week
                                    </option>
                                    <option value="month" <?php echo $dateFilter === 'month' ? 'selected' : ''; ?>>This
                                        Month</option>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Activity Logs (<?php echo $totalLogs; ?> total)
                        </h6>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php while ($log = $logs->fetch_assoc()):
                                        ...
                                        <tr>
                                            ...
                                            <td class="log-entry"><?php echo htmlspecialchars($log['description'] ?? ''); ?>
                                            </td>
                                            <td class="log-entry"><?php echo htmlspecialchars($log['ip_address'] ?? ''); ?>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    <?php if ($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="?page=<?php echo $page - 1; ?>&log_type=<?php echo $logType; ?>&date_filter=<?php echo $dateFilter; ?>">Previous</a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php for ($i = max(1, $page - 2); $i <= min($totalPages, $page + 2); $i++): ?>
                                        <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                            <a class="page-link"
                                                href="?page=<?php echo $i; ?>&log_type=<?php echo $logType; ?>&date_filter=<?php echo $dateFilter; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                    ...
                                    <?php if ($page < $totalPages): ?>
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="?page=<?php echo $page + 1; ?>&log_type=<?php echo $logType; ?>&date_filter=<?php echo $dateFilter; ?>">Next</a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </nav>
